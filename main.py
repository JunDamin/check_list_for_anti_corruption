    ...
    def route_change(route):
        ...
        home = ft.View(
            ...
            [
                ...
                ft.ElevatedButton("직무관련자와의 거래 신고 의무 체크리스트", on_click=lambda _: page.go("/job_related_check1")),
                ft.ElevatedButton("퇴직자 사적접촉 신고 의무 체크리스트", on_click=lambda _: page.go("/retired_check1")),
            ],
        )
        ...
        present_check1 = ft.View(
            ...
            [
                ...
                ft.ElevatedButton(
                    "1회 100만원 이하", on_click=lambda _: page.go("/present_check2")
                ),
                ft.ElevatedButton("처음으로", on_click=lambda _: page.go("/")),
            ],
        )
        ...
        present_check2 = ft.View(
            ...
            [
                ...
                ft.ElevatedButton(
                    "기타 기관장이 정하는 임직원", on_click=lambda _: page.go("/present_check3")
                ),
                ft.ElevatedButton(
                    "해당되는 사항이 없습니다.", on_click=lambda _: page.go("/present_check_ok")
                ),
            ],
        )
...
| 경조사비 | 5만원 이하 | 화환, 조화의 경우 10만원 |""",
                ...
                ft.ElevatedButton(
                    "해당되는 사항이 없습니다.", on_click=lambda _: page.go("/present_declaration")
                ),
            ],
        )
        ...
        stakeholder_check1 = ft.View(
            ...
            [
                ...
                ft.ElevatedButton(
                    "해당없음", on_click=lambda _: page.go("/stakeholder_ok")
                ),
                ft.ElevatedButton("처음으로", on_click=lambda _: page.go("/")),
            ],
        )
        ...
        stakeholder_check3 = ft.View(
            ...
            [
                ...
                ft.ElevatedButton(
                    "해당없음", on_click=lambda _: page.go("/stakeholder_check4")
                ),
                ft.ElevatedButton("처음으로", on_click=lambda _: page.go("/")),
            ],
        )
        ...
        stakeholder_ok = ft.View(
            ...
            [
                ...
                ft.Text("사적이해관계자 신고·회피 의무가 없어 종료"),
                ft.ElevatedButton("처음으로", on_click=lambda _: page.go("/")),
            ],
        )
        ...
        job_related_check1 =  ft.View(
            ...
            [
                ...
                ft.ElevatedButton(
                    "해당없음", on_click=lambda _: page.go("/job_related_ok")
                ),
                ft.ElevatedButton("처음으로", on_click=lambda _: page.go("/")),
            ],
        )
        ...
        job_related_check2 =  ft.View(
            ...
            [
                ...
                ft.Text("공직자 자신, 배우자, 직계존속·비속, 생계를 같이 하는 배우자의 직계존속·비속이 단독으로 또는 합산하여 다음 각 항목 중 어느 하나에 해당하는 주식·지분 등을 소유하고 있는 법인·단체 "),
                ft.ElevatedButton(
                    "발행주식 총수의 30% 이상",
                    on_click=lambda _: page.go("/job_related_check3"),
                ),
        ...
        job_related_check4 =  ft.View(
            ...
            [
                ...
                ft.ElevatedButton(
                    "해당없음", on_click=lambda _: page.go("/job_related_declaration")
                ),
                ft.ElevatedButton("처음으로", on_click=lambda _: page.go("/")),
            ],
        )
        ...
        job_related_routes = {"/job_related_check1": job_related_check1, "/job_related_check2": job_related_check2, "/job_related_check4": job_related_check4, "/job_related_ok": job_related_ok, "/job_related_declaration": job_related_declaration}
        ...
        retired_check1 = ft.View(
            ...
            [
                ft.AppBar(
                    title=ft.Text("Checklist 1 퇴직자 사적접촉"),
                    bgcolor=ft.colors.SURFACE_VARIANT,
                ),
                ft.ElevatedButton(
                ...
                ft.ElevatedButton(
                    "해당없음", on_click=lambda _: page.go("/retired_check2")
                ),
                ft.ElevatedButton("처음으로", on_click=lambda _: page.go("/")),
            ],
        )
        ...
        retired_check2 = ft.View(
            ...
            [
                ...
                ft.ElevatedButton(
                    "해당없음", on_click=lambda _: page.go("/retired_ok")
                ),
                ft.ElevatedButton("처음으로", on_click=lambda _: page.go("/")),
            ],
        )
        ...
        retired_check3 = ft.View(
            ...
            [
                ft.AppBar(
                    title=ft.Text("Checklist 3 퇴직자 사적접촉"),
                    bgcolor=ft.colors.SURFACE_VARIANT,
                ),
                ft.ElevatedButton(
        ...
        retired_ok = ft.View(
            ...
            [
                ...
                ft.Text("퇴직자 사적접촉 신고·회피 의무가 없어 종료"),
                ft.ElevatedButton("처음으로", on_click=lambda _: page.go("/")),
            ],
        )
        ...
        retired_routes = {"/retired_check1": retired_check1, "/retired_check2": retired_check2, "/retired_check3": retired_check3, "/retired_ok": retired_ok, "/retired_declaration": retired_declaration}
